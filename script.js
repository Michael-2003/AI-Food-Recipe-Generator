...
const mealDetailsContent = document.querySelector('.meal-details-content');  //check this
...
function getMealList(){
    ...
    fetch(`http://www.themealdb.com/api/json/v1/1/filter.php?i=${searchInputTxt}`).then(response => response.json())
    .then(data=>{
        let html="";
        if(data.meals){
            ...
            html="Sorry, we didn't fint any meal! ";
